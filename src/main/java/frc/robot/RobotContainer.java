...
public class RobotContainer {
  ...
  private void configureAutonomous() {
    autoChooser.setDefaultOption("Five_Cycle_Processor", new FiveCycle(this, false, groundIntake));
    autoChooser.addOption("Five_Cycle_Non_Processor", new FiveCycle(this, true, groundIntake));
