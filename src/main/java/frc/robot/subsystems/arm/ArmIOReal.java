...
public class ArmIOReal implements ArmIO {
  ...
  private final StatusSignal<Double> closedLoopProportionalOutput = armMotor.getClosedLoopProportionalOutput();
  private final StatusSignal<Double> closedLoopIntegral = armMotor.getClosedLoopIntegratedOutput();
  private final StatusSignal<Double> closedLoopDerivative = armMotor.getClosedLoopDerivativeOutput();
  ...
  public ArmIOReal() {
    ...
    BaseStatusSignal.setUpdateFrequencyForAll(50.0, armPIDGoal, armStatorCurrent, feedForwardOutput, closedLoopOutput, closedLoopProportionalOutput, closedLoopIntegral, closedLoopDerivative);
  ...
  public void update() {
    ...
    DogLog.log("Arm/Motor/closed loop proportional", closedLoopProportionalOutput.getValueAsDouble());
