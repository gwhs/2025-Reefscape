...
public class groundIntakeIOSim implements groundIntakeIO {
	...
	private SingleJointedArmSim pivotMotorSim = new SingleJointedArmSim(
	...
	private FlywheelSim spinMotorSim = new FlywheelSim(
			LinearSystemId.createFlywheelSystem(
				DCMotor.getFalcon500Foc(1),
				0.0001,
				groundIntakeConstants.SPIN_GEAR_RATIO), 
			DCMotor.getFalcon500Foc(1)
			);
