...
public class ClimbConstants {
  ...
  public static final double CLIMB_CLIMB_POSITION = 2.67; // 2.77
  public static final double STOW_CLIMB_POSITION = 0.1;
  public static final double LATCH_CLIMB_POSITION = 1.25;
}
